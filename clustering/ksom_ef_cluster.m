function [PARout] = ksom_ef_cluster(DATA,PAR)

% --- KSOM-EF Clustering Function ---
%
%   [PARout] = ksom_ef_cluster(DATA,PAR)
% 
%   Input:
%       DATA.
...
for ep = 1:Nep
    ...
    for i = 1:N
        ...
        % Get Winner Neuron in Feature Space
