function [] = showErrorComparison(statsComp,names)

% --- Provide error comparison of n turns of Classifiers ---
%
...
for i = 1:n_stats
    Mat_boxplot1(:,i) = statsComp{i}.err_vect';
end
...
hold on
media1 = mean(Mat_boxplot1);    % Mean error rate
plot(media1,'*k')
hold off
