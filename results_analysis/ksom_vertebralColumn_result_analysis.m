...
% Analysis of results from ksom model and VertebralColumn dataset
...
%% VERTEBRAL COLUMN (02 - binary), KSOM, HOLD 1, BEST HPS, VARIOUS KERNELS
...
str1 = 'vertebral_2_';
ksom = {'ksomef','ksomgd'};
str2 = '_hold_1_hpo_b_norm_3_lbl_';
lbl = {'1','2','3'};
str3 = '_nn_1_Nep_50_Nprot_30_Kt_';
kt = {'1','2','3','4','5','6','7','8'};
