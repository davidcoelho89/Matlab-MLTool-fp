%% ANALISE ESTATISTICA DOS DADOS - 16 HARM

% David Nascimento Coelho
% Última alteração: 09/04/2015

%% TESTE 01 - Boxplot dos dados (não normalizados)

clear all; close all; clc;

load data_FREQ_4;           %16 Harmonicas
data = data';               %dados (1 amostra por linha)
rot = rot';                 %rotulos (1 amostra por linha)

harm = 2*[0.5 1 1.5 2 2.5 3 3.5 4 4.5 5 5.5 6 6.5 7 7.5 8];
data = data(:,harm);
...
harm = 2*[0.5 1.5 2 2.5 3 3.5 4 4.5 5 5.5 6 6.5 7 7.5 8];
data = data(:,harm);

labels = {'0.5' '1.5' '2' '2.5' '3' '3.5' '4' ...
          '4.5' '5' '5.5' '6' '6.5' '7' '7.5' '8' };
