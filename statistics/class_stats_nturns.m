...
err_max = 0;                % Maximum accuracy obtained
err_min_index = 1;          % index of Minimum accuracy obtained
err_min = 1;                % Minimum accuracy obtained
err_max_index = 1;          % index of Maximum accuracy obtained
err_mean = 0;               % mean accuracy rate
err_std = 0;                % standard deviation of accuracy rate
err_cv = 0;                 % Coefficient of Variation of accuracy rate
