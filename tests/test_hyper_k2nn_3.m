...
% Rotating Hyperplane and isk2nn classifier
...
OPT =  struct('prob',26,'prob2',1,'norm',3,'lbl',1,'Nr',1, ...
              'hold',2,'ptrn',0.7,'file', ...
              'hyper_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_lin_nn.mat');
...
OPT =  struct('prob',26,'prob2',1,'norm',3,'lbl',1,'Nr',1, ...
              'hold',2,'ptrn',0.7,'file', ...
              'hyper_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_gau_nn.mat');
...
OPT =  struct('prob',26,'prob2',1,'norm',3,'lbl',1,'Nr',1, ...
              'hold',2,'ptrn',0.7,'file', ...
              'hyper_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_pol_nn.mat');
...
OPT =  struct('prob',26,'prob2',1,'norm',3,'lbl',1,'Nr',1, ...
              'hold',2,'ptrn',0.7,'file', ...
              'hyper_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_cau_nn.mat');
...
OPT =  struct('prob',26,'prob2',1,'norm',3,'lbl',1,'Nr',1, ...
              'hold',2,'ptrn',0.7,'file', ...
              'hyper_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_sig_nn.mat');
