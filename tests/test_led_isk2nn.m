...
% LED Dataset and isk2nn classifier (using isk2nn pipeline)
...
% DATASET: 32 (LED) / NORM: 3 (x-mean)/std / LBL: 1 [-1 +1]

DATAopt =  struct('prob',32,'prob2',1,'norm',3,'lbl',1);
...
DATAopt.file = 'led_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_lin_nn.mat';
...
DATAopt.file = 'led_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_gau_nn.mat';
...
DATAopt.file = 'led_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_pol_nn.mat';
...
DATAopt.file = 'led_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_cau_nn.mat';
...
DATAopt.file = 'led_isk2nn_hpo1_norm3_Dm2_Ss1_Us1_Ps2_sig_nn.mat';
